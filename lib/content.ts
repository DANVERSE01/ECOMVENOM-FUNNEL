// All copy is verbatim from
// 01_INPUT/funnel_text_forms_schedule_confirmation_json/
...
export const curriculum = {
  ...
  sub: "Everything you need to succeed, step-by-step.",
  modules: [
    { n: "01", title: "Introduction to Dropshipping", bullets: ["What is Dropshipping?", "A-Z purchase workflow"] },
    { n: "02", title: "Types of Stores", bullets: ["Best store types", "Store model analysis"] },
    { n: "03", title: "U.S. Market Strategies", bullets: ["Top U.S. suppliers", "PlusBase platform", "Winning product research"] },
    { n: "04", title: "Marketing Strategies", bullets: ["Influencer Marketing", "Ambassador setup", "Content Marketing"] },
    { n: "05", title: "Saudi & Gulf Market Strategies", bullets: ["Saudi/Gulf ad strategies", "Local suppliers", "Gulf platforms", "Gulf product-market fit"] },
    { n: "06", title: "Payment & Store Setup", bullets: ["Payment gateways", "Free store setup bonus"] },
  ],
};
...
export const schedule = {
  ...
  // Source listed: 02:00 AM → 12:40 PM in 20-min steps.
  slots: [
    "02:00 AM","02:20 AM","02:40 AM","03:00 AM","03:20 AM","03:40 AM",
    "04:00 AM","04:20 AM","04:40 AM","05:00 AM","05:20 AM","05:40 AM",
    "06:00 AM","06:20 AM","06:40 AM","07:00 AM","07:20 AM","07:40 AM",
...
export const confirmation = {
  banner: "DO NOT CLOSE THIS PAGE",
  h1: "CONFIRMED!",
  sub: "Your call has been booked",
  stepsHeading: "IMPORTANT PRE-CALL STEPS:",
  steps: [
    {
      title: "Step 1: Watch This Video",
      body: "",
    },
    {
