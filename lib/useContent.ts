...
const arGraduationGift = {
  ...
  /* الإضافات الجديدة بطلب المؤسس */
  bonusesHeading: "ما الذي يأتي معك في المقعد",
  bonusesSub: "أبعد من المنهج — منظومة الدعم التشغيلي اللي حواليه.",
  bonuses: [
    {
      tag: "متجر",
      title: "تصميم متجر مجاني مع منتج إلى منتجين",
      body: "فريقنا يبني لك المتجر ويزوّده بمنتج أو اثنين جاهزين للاختبار الفعلي — حتى لا تخسر الزخم في أول خطوة.",
    },
    {
      tag: "ميديا",
      title: "فريق Media Buying يدير إعلاناتك",
      body: "فريق مختص يتولى ضبط الحملات، بناء الجماهير، والتحسين اليومي على حسابك — وأنت تركّز على التشغيل.",
    },
    {
      tag: "استرداد",
      title: "استرداد كامل قيمة الكورس عند 50 أوردر سعودي",
      body: "إذا وصلت إلى 50 طلب مدفوع مع سيلر في السوق السعودي، نُعيد لك كامل قيمة البرنامج. النظام هو الإثبات.",
    },
    {
      tag: "1:1",
      title: "اجتماع أسبوعي one-to-one مع يوسف",
      body: "مكالمة أسبوعية مباشرة مع يوسف عادل — تراجعون فيها ما تم تنفيذه، وما تأخر، وما يجب تعديله قبل السبرنت التالي.",
    },
  ],
};
