...
// ScrambleTextPlugin and DrawSVGPlugin stay replaced by local utilities in
// @/lib/motion.ts; SplitText ships with the installed GSAP 3.15 package.

if (typeof window !== "undefined") {
  gsap.registerPlugin(ScrollTrigger, Flip, CustomEase, MotionPathPlugin, SplitText);
...
export { gsap, ScrollTrigger, Flip, CustomEase, SplitText };
