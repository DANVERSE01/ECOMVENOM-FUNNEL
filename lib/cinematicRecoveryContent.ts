...
export const recoveryCopy = {
  ar: {
    ...
    mechanism: {
      ...
      body:
        "‏قبل أي إنفاق، النظام بيربط 4 طبقات: إشارة الطلب، هندسة العرض، بناء المتجر، وقرار الإعلان. كل قرار يدخل بمدخلات، يطلع بنتيجة قابلة للقياس.",
      steps: [
    ...
    founder: {
      ...
      body:
        "‏يوسف بيشغّل المنهج زي ما بيشغّل ستوراته: قراءة سوق، اختيار منتج بإشارات، عرض مبني على اعتراضات، وقرار إعلان بأرقام. مفيش حماس، فيه تشغيل.",
      quote: "‏لما التجارة تتحول من حظ لنظام، الأرقام بتفرق.",
    },
    offer: {
      eyebrow: "العرض",
      title: "لا تبدأ من صفحة بيضاء. تبدأ من متجر جاهز للاختبار.",
      body:
        "المقعد يجمع المنهج مع تنفيذ حوله: متجر مجاني بمنتج إلى منتجين، دعم Media Buying للإعلانات، اجتماع أسبوعي مع يوسف، ومسار استرداد مشروط عند إثبات 50 أوردر سعودي.",
    ...
    faq: {
      ...
      items: [
        { q: "هل أحتاج خبرة سابقة؟", a: "لا. نبدأ من الأساسيات، لكن المطلوب تنفيذ جاد لا مشاهدة فقط." },
        { q: "هل أحتاج ميزانية كبيرة؟", a: "لا. تبدأ باختبار مضبوط وتقرأ الأرقام قبل التوسّع." },
        { q: "هل يناسب السوق السعودي؟", a: "نعم. السوق السعودي والخليجي لهما معالجة مختلفة عن السوق الأمريكي." },
        { q: "هل المتجر المجاني حقيقي؟", a: "نعم بعد إتمام البرنامج، بمنتج إلى منتجين حسب السوق المختار." },
        { q: "هل توجد وعود أرباح؟", a: "لا. لا نضمن نتيجة مالية. نضمن مسارًا أوضح من التخمين." },
      ],
    },
    finalCta: {
      eyebrow: "الخطوة التالية",
      title: "إذا كنت تريد متجرًا مبنيًا على قرار، ابدأ من الطلب.",
      body: "‏الطلب بيقيّم التوافق الأول. لو فيه مساحة، بنتحرك لمكالمة مركّزة وخطة سوق واضحة.",
    },
  },
  en: {
    hero: {
    ...
    mechanism: {
      ...
      body:
        "Before spend, the system links four layers: demand signal, offer engineering, store build, and ad decision. Every decision enters with inputs and exits with a measurable outcome.",
      steps: [
    ...
    founder: {
      ...
      body:
        "Youssef runs the curriculum the way he runs his stores: read the market, pick a product from signals, build an offer around objections, decide on ads from numbers. No hype — operating discipline.",
      quote: "When ecommerce stops being luck, the numbers start telling a story.",
    },
    offer: {
      eyebrow: "Offer",
      title: "Do not start from a blank page. Start from a test-ready store.",
      body:
        "The seat combines curriculum with execution support: a free store build with one to two products, media-buying support, weekly one-on-one review with Youssef, and a conditional refund path when 50 Saudi-market orders are proven.",
    ...
    faq: {
      ...
      items: [
        { q: "Do I need prior experience?", a: "No. We start from fundamentals, but you need serious execution, not passive watching." },
        { q: "Do I need a large budget?", a: "No. The point is controlled testing before scaling." },
        { q: "Does it fit the Saudi market?", a: "Yes. Saudi and Gulf positioning are handled differently from the U.S. market." },
        { q: "Is the free store build real?", a: "Yes, after completion, with one to two products for your selected market." },
        { q: "Are profit outcomes guaranteed?", a: "No. Financial outcomes are not guaranteed. The promise is a clearer operating path." },
      ],
    },
    finalCta: {
      eyebrow: "Next move",
      title: "If you want a store built on decisions, start with the application.",
      body: "The application gates fit first. If there's a match, we move to a focused call and a clear market plan.",
    },
  },
