...
if (typeof window !== "undefined") {
  gsap.registerPlugin(ScrollTrigger, SplitText, Flip, CustomEase, ScrambleTextPlugin, DrawSVGPlugin, MotionPathPlugin);
...
export { gsap, ScrollTrigger, SplitText, Flip, CustomEase, ScrambleTextPlugin, DrawSVGPlugin };
